 ...
 */
    ...
    public static void main(String[] args) throws Exception {
        ...
        String s[] = createTextFiles(1000, 1, 99999);
        System.out.print("[");
        int i;
        ...
        int n = getNumOfLines(s);
        //int n=7;
        System.out.println(" 1 total number of rows: " + n+ " Time: " + (System.currentTimeMillis() - currtime) + "ms");
        currtime = System.currentTimeMillis();
        int na = getNumOfLinesThreads(s);
        System.out.println(" 2 total number of rows: " + na + " Time: " + (System.currentTimeMillis() - currtime) + "ms");
        currtime = System.currentTimeMillis();
        int naa = getNumOfLinesThreadPool(s);
        System.out.println(" 3 total number of rows: " + naa+ " Time: " + (System.currentTimeMillis() - currtime) + "ms");
        System.out.println(deleteTextFiles(s)+ " files deleted.") ;
